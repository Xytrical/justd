...
## Refactor Table
The table component has been significantly refactored. It now supports a new prop called `bleed`, which is set to `false` by default. You can see an example in [Sidebar 15](/blocks/sidebar/sidebar-15).
