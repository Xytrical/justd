...
```
bunx shadcn@latest init https://intentui.com/r/style/default
```

Once initialized, you can add components by running:

```
npx shadcn@latest add https://intentui.com/r/ui/<component>
```

Let’s say you want to add a card component. Just replace `<component>` with `card`, like this:
```
npx shadcn@latest add https://intentui.com/r/ui/card
```
